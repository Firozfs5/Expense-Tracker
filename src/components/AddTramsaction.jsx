...
const AddTransaction=()=>{
    ...
    return (
        ...
        <div className="p-2  w-88">
            <h2 className=" font-semibold text-[16px] p-1 border-b-2 border-gray-400 dark:text-white">Add New Transactions</h2>
            ...
            <div className="flex justify-between mt-4 items-center">
               <h1 className="dark:text-white">Amount</h1>
               <input type="text" 
               value={Money} 
               onChange={(e)=>setMoney(e.target.value)} 
               className="bg-white w-64 p-1 rounded" 
